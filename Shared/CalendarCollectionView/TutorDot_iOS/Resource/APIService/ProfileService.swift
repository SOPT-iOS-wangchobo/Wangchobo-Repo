...
struct ProfileService {
    ...
    func getClassLid(completion: @escaping (NetworkResult<Any>) -> Void) {
        ...
        let header: HTTPHeaders = ["jwt": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjc2LCJuYW1lIjoic2Vod2EiLCJpYXQiOjE1OTY0NzA0NDAsImV4cCI6MTU5NzY4MDA0MCwiaXNzIjoib3VyLXNvcHQifQ.46A3SnaoruuzHdBxmy0myMGt3kh5JPqzRSAbz_6esyA"]
